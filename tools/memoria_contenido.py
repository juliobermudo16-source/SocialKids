...
MODULOS = [
    ...
    ("domain/engine/TermómetroEngine.kt", "Motor del Termómetro Emocional: precisión de la medida y proporcionalidad de la estrategia."),
    ...
    ("domain/usecase/Estadísticas.kt", "Resumen del diario de ánimo y cálculo de la racha actual y la mejor racha."),
    ...
    ("ui/screens/ActividadTermómetro.kt", "Termómetro Emocional: medición de intensidad y elección de estrategia."),
    ...
    ("ui/screens/PantallaEstadísticas.kt", "Números calculados desde la base de datos y gráfico semanal."),
